        ...
        <ul ref={slider}>
          <li>
            <div className="slide">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa doloribus tempora amet, accusamus nesciunt quasi iusto possimus error alias asperiores.</p>
            </div>
          </li>
          <li>
            <div className="slide">
